 ...
 * @author PC
 */
public class Letter14 extends javax.swing.JFrame {

    /**
     * Creates new form Letter14
     */
    ...
    public Letter14() {
        ...
        bgPath = IOFileFont.doc("src/controller/BG14.txt");
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/3/small/4.jpg"))); // NOI18N
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/3/small/13.jpg"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/3/small/16.jpg"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/3/small/18.jpg"))); // NOI18N
        ...
        m_letterTP2.setText("#14\n\n\"Trưởng thành, thực ra chính\nlà quá trình không ngừng từ \nbiệt và buông bỏ, những gì \nchúng ta đạt được đều phải \nđánh đổi bằng một giá nào\nđó. Nhưng cũng chỉ khi hiểu\nđược buông bỏ, chúng ta mới\ncó thể nắm trong tay những\nđiều quan trọng đối với \nbản thân.\"");
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/3/bigger/1 (4).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG14.txt", bgPath);
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/3/bigger/1 (13).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG14.txt", bgPath);
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/3/bigger/1 (16).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG14.txt", bgPath);
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/3/bigger/1 (18).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG14.txt", bgPath);
    ...
    private void m_taiAnhLenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_taiAnhLenActionPerformed
        // TODO add your handling code here:
        File f1= new File("src/controller/BG14.txt");
        if (f1.exists()) {
            bgPath = IOFileFont.doc("src/controller/BG14.txt");
        ...
        if(x==JFileChooser.APPROVE_OPTION) {
            ...
            IOFileFont.viet("src/controller/BG14.txt", f.getAbsolutePath());
