 ...
 * @author PC
 */
public class Letter8 extends javax.swing.JFrame {

    /**
     * Creates new form Letter8
     */
    ...
    public Letter8() {
        ...
        bgPath = IOFileFont.doc("src/controller/BG8.txt");
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (29).jpg"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/5/small/1 68.jpg"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (31).jpg"))); // NOI18N
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (32).jpg"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (33).jpg"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (34).jpg"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (35).jpg"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (38).jpg"))); // NOI18N
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (42).jpg"))); // NOI18N
        ...
        m_letterTP2.setText("#8\n\n\"Bất kể đêm trước trải qua\nđau khổ khóc không thành\ntiếng như thế nào, sáng hôm \nsau tỉnh dậy người người trong\nthành phố vẫn không ngừng \nbận rộn vội vã. Vui hay không \nvui, chốn thành thị phồn hoa \nkhông rảnh rỗi chờ đợi bạn, bạn\nchỉ có thể khắc ghi trong lòng \nhoặc lãng quên. Trạm dừng \n\"từng yêu\" hoặc \"từng hận\"\nđó trên con đường đời của \nbạn, ngày tháng đó bạn bán\nmạng cố gắng nhưng không\ncảm nhận được hy vọng, tất\ncả rồi sẽ qua đi.\"");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 280, 470));
        ...
        jPanel1.add(m_BG, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -50, 360, 690));
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (29).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG8.txt", bgPath);
    }//GEN-LAST:event_jLabel2MouseClicked

    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/5/bigger/1 68.jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG8.txt", bgPath);
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (31).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG8.txt", bgPath);
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (32).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG8.txt", bgPath);
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (33).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG8.txt", bgPath);
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (34).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG8.txt", bgPath);
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (35).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG8.txt", bgPath);
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (38).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG8.txt", bgPath);
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (42).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG8.txt", bgPath);
    ...
    private void m_taiAnhLenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_taiAnhLenActionPerformed
        // TODO add your handling code here:
        File f1= new File("src/controller/BG8.txt");
        if (f1.exists()) {
            bgPath = IOFileFont.doc("src/controller/BG8.txt");
        ...
        if(x==JFileChooser.APPROVE_OPTION) {
            ...
            IOFileFont.viet("src/controller/BG8.txt", f.getAbsolutePath());
