 ...
 * @author PC
 */
public class Letter9 extends javax.swing.JFrame {

    /**
     * Creates new form Letter9
     */
    ...
    public Letter9() {
        ...
        bgPath = IOFileFont.doc("src/controller/BG9.txt");
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (43).jpg"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (44).jpg"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (45).jpg"))); // NOI18N
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (30).jpg"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/1/small/1 (48).jpg"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/5/small/1 4.jpg"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/2/small/1 (3).jpg"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/5/small/1 5.jpg"))); // NOI18N
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Data/BG/2/small/1 (11).jpg"))); // NOI18N
        ...
        m_letterTP2.setEditable(false);
        m_letterTP2.setColumns(20);
        m_letterTP2.setRows(30);
        m_letterTP2.setText("#9\n\n\"Bạn là một người mạnh mẽ, \nbất kể lúc nào cũng bắt mình\nphải làm được trọn vẹn 100%\nnhững kì vọng của bản thân. \nNhưng nghiêm khắc quá cũng\nkhông phải là điều tốt, bạn \nkhông phải là thiên tài, hãy\ncho phép mình phạm sai lầm, \nđừng quá vội vàng, những\nnỗ lực của bạn, thời gian sẽ\ngiúp bạn thực hiện.\"");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, 260, 420));
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (43).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG9.txt", bgPath);
    }//GEN-LAST:event_jLabel2MouseClicked

    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (44).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG9.txt", bgPath);
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (45).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG9.txt", bgPath);
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (30).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG9.txt", bgPath);
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/1/bigger/1 (48).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG9.txt", bgPath);
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/5/bigger/1 4.jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG9.txt", bgPath);
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/2/bigger/1 (3).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG9.txt", bgPath);
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/5/bigger/1 5.jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG9.txt", bgPath);
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        // TODO add your handling code here:
        bgPath="src/Data/BG/2/bigger/1 (11).jpg";
        m_BG.setIcon(new ImageIcon(bgPath));
        IOFileFont.viet("src/controller/BG9.txt", bgPath);
    ...
    private void m_taiAnhLenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_taiAnhLenActionPerformed
        // TODO add your handling code here:
        File f1= new File("src/controller/BG9.txt");
        if (f1.exists()) {
            bgPath = IOFileFont.doc("src/controller/BG9.txt");        
        }
        ...
        if(x==JFileChooser.APPROVE_OPTION) {
            ...
            IOFileFont.viet("src/controller/BG9.txt", f.getAbsolutePath());
